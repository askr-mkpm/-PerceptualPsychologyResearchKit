...
const Player: React.FC = () =>
{
    ...
    {
        alert("動画プレイヤーが起動します。 \n  " 
        +"再生の際は,プレイヤー内の再生ボタンではなく、プレイヤー下の、青い[PLAY]ボタンをおしてください。\n \n  "
        +"誤ってプレイヤー内の再生ボタンを押してしまった場合、お手数ですがページを更新して、再度URLを入力してプレイヤーを起動してください。 \n \n "
        +"再生を開始したら、dボタンで潜時を記録してください。 \n \n  "
        +"また、escボタンで動画の一時停止が可能です。" );
    }
    ...
    const alertInputInfomation = () =>
    {
        ...
        +"二つ以上スライダーがある場合、一つのスライダーを動かした際、他のスライダーも動いてしまいますが、他のスライダーで既に記録された値に影響はありません。");
    }
